...
<div class="col-sm-9 page">
    <div class="row">
        ...
        <div class="container">
            <form id="optForm" action="/admin/list" method="get" style="display: inline">
                <select id="country">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                <c:forEach items="${admins.result.content}" var="admins">
                    <tr>
                        <td><c:out value="${admins.id}"/></td>
                        <td><a href="#"><c:out value="${admins.userid}"/></a></td>
                        <td><c:out value="${admins.name}"/></td>
                        <td><c:out value="${admins.phone}"/></td>
                        <td><c:out value="${admins.email}"/></td>
                        <td><c:out value="${admins.country}"/></td>
                        <td><a href="#">2건</a></td>
                        <td><a href="#">2건</a></td>
                    </tr>
                </c:forEach>
